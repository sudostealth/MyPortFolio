...
export function Navbar() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      // If we've scrolled past the landing hero (approx 100vh), show navbar
  ...
  // Hide Navbar completely when not scrolled down past the landing hero
  ...
  return (
    <motion.header
      ...
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 glass shadow-lg shadow-primary/5`}
    >
